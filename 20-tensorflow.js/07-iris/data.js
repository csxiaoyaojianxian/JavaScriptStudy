...
// 4个输入特征(花萼花瓣长度宽度) + 1个类别(0山鸢尾 1变色鸢尾 2维吉尼亚鸢尾)
const IRIS_DATA = [
 ...
 *
 * @param testSplit 验证集占比，用于分割数据 Fraction of the data at the end to split as test data: a
 *   number between 0 and 1.
 *
